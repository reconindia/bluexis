    ...
    <div className="flex flex-col scroll-smooth selection:bg-gold selection:text-ink">
      ...
      <section className="pt-40 pb-24 border-b border-line bg-paper relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <span className="text-xs uppercase tracking-[0.4em] font-bold text-gold mb-8 block font-sans tracking-widest">System Authority</span>
            <h1 className="font-display font-bold text-6xl md:text-8xl leading-none tracking-tighter mb-12">
              Terms of <br />
              <span className="font-serif italic font-light italic-text text-gold">Management.</span>
            </h1>
            <p className="text-xl md:text-2xl font-light text-ink/85 max-w-2xl leading-relaxed italic font-serif">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {principles.map((item, i) => (
              ...
              >
                ...
                <p className="text-lg font-light leading-relaxed italic text-ink/80">{item.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div>
              ...
              <p className="text-xl font-light text-paper/85 mb-12 leading-relaxed font-sans">
              ...
              <div className="space-y-12">
                {[
                  ...
                  <div key={i} className="border-t border-ink/5 pt-8 first:border-0 first:pt-0 font-sans">
                    ...
                    <p className="text-ink/60 text-sm font-light leading-relaxed italic font-serif">{item.d}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-40 bg-paper grid-bg">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold uppercase tracking-tighter mb-12 leading-tight">
            The Ethics of <span className="font-serif italic font-light text-gold">Expert Management.</span>
          </h2>
          <p className="text-lg font-light text-ink/40 leading-relaxed mb-6 uppercase tracking-widest italic italic-text font-serif">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-white border border-line p-16 flex flex-col md:flex-row justify-between items-center gap-12">
             <div className="max-w-lg">
                ...
                <p className="text-sm font-light text-ink/60 uppercase tracking-widest leading-loose italic font-serif">
